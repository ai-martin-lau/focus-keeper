...
最新バージョン：[`focus-keeper.dmg`](https://github.com/ai-martin-lau/focus-keeper/releases/latest/download/focus-keeper.dmg)
...
1. DMG を開きます。
2. `Focus Keeper.app` を Applications にドラッグします。
...
3. セキュリティまでスクロールし、`Focus Keeper.app` の Open Anyway をクリックします。
...
DMG は `dist/focus-keeper.dmg` に生成されます。
