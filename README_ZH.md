...
下载最新版本：[`focus-keeper.dmg`](https://github.com/ai-martin-lau/focus-keeper/releases/latest/download/focus-keeper.dmg)
...
1. 打开 DMG。
2. 把 `Focus Keeper.app` 拖到 Applications。
...
1. 打开系统设置。
2. 进入隐私与安全性。
3. 滚动到安全性，点击 `Focus Keeper.app` 旁边的仍要打开。
4. macOS 再次询问时确认打开。
...
DMG 会生成到 `dist/focus-keeper.dmg`。
